...
$modulePaths = @{
    ...
    'core' = @('crates/evohime-core', 'crates/evohime-cli-contract', 'crates/model-gateway', 'crates/permissions', 'crates/tool-runtime', 'crates/evohime-local-storage')
    'supervisor' = @('crates/evohime-supervisor', 'crates/evohime-process')
    'cli' = @('crates/evohime-cli', 'crates/evohime-cli-protocol', 'crates/evohime-cli-contract')
