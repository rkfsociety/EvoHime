...
$cargoArguments += @('-p', 'evohime-core', '-p', 'evohime-supervisor', '-p', 'evohime-updater', '-p', 'evohime-receipts')
...
$requiredNative = @('evohime-core.exe', 'evohime-supervisor.exe', 'evohime-transaction.exe', 'evohime-verify.exe')
