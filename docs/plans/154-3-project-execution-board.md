# План 154.3 — Project Execution Board: IPC, projection и UI

Статус: этап 3 для [плана 154.0](./154-0-project-execution-board.md); issue: [#134](https://github.com/rkfsociety/EvoHime/issues/134).
