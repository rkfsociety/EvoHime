# План 99.4 — Composable Termination Conditions: typed stop algebra для agent/team runs: verification, release-evidence и закрытие

Статус: этап 4 для [плана 99.0](./99-0-composable-termination-conditions-follow-up.md); после [плана 99.3](./99-3-composable-termination-conditions-follow-up.md).
...
- План 99.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `99-0` … `99-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/79)
