# План 151.2 — Contextual Next-Step Suggestions: runtime-интеграция и recovery

Статус: этап 2 для [плана 151.0](./151-0-contextual-next-step-suggestions.md); issue: [#131](https://github.com/rkfsociety/EvoHime/issues/131).
