# План 126.1 — Design Intent Review Lane: Core-контракт, schema и storage

Статус: этап 1 для [плана 126.0](./126-0-design-intent-review-lane.md); issue: [#107](https://github.com/rkfsociety/EvoHime/issues/107).
