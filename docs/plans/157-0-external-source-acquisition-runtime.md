# План 157.0 — External Source Acquisition Runtime

Статус: предложено по [issue #137](https://github.com/rkfsociety/EvoHime/issues/137). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **External Source Acquisition Runtime** как versioned/revision-aware capability поверх существующей архитектуры EvoHime. Контур должен иметь bounded contract, одного владельца состояния, безопасные transitions, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./157-1-external-source-acquisition-runtime.md)
- [Этап 2 — runtime-интеграция и recovery](./157-2-external-source-acquisition-runtime.md)
- [Этап 3 — IPC, projection и UI](./157-3-external-source-acquisition-runtime.md)
- [Этап 4 — verification, release evidence и закрытие](./157-4-external-source-acquisition-runtime.md)
...
- [#137 External Source Acquisition Runtime](https://github.com/rkfsociety/EvoHime/issues/137)
