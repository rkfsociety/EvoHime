# План 149.2 — Interactive Model Compare Workbench: runtime-интеграция и recovery

Статус: этап 2 для [плана 149.0](./149-0-interactive-model-compare-workbench.md); issue: [#129](https://github.com/rkfsociety/EvoHime/issues/129).
