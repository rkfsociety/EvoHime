# План 91.4 — Architect-Editor Model Pipeline: раздельные reasoning и code-editing фазы: verification, release-evidence и закрытие

Статус: этап 4 для [плана 91.0](./91-0-architect-editor-model-pipeline.md); после [плана 91.3](./91-3-architect-editor-model-pipeline.md).
...
- План 91.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `91-0` … `91-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/71)
