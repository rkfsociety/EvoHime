# План 139.3 — Kernel Capability Facade: IPC, projection и UI

Статус: этап 3 для [плана 139.0](./139-0-kernel-capability-facade.md); issue: [#120](https://github.com/rkfsociety/EvoHime/issues/120).
