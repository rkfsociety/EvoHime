...
Статус: исполняемый план текущего desktop-цикла. Для фактического состояния используйте [`current-state.md`](../current-state.md), для долгосрочных направлений — [`99-roadmap.md`](99-roadmap.md).
...
Проверка 2026-08-14: Rust, Electron, C#/WinUI compatibility, protocol, bundle и
...
долгосрочного [`99-roadmap.md`](99-roadmap.md) после отдельного подтверждения приоритета.
...
При расхождении этого плана с реализацией сначала обновляется статус на основании кода и тестов. Все планы лежат в каталоге `docs/plans/`: исполняемый цикл — здесь, долгосрочные направления — в [`99-roadmap.md`](99-roadmap.md).
