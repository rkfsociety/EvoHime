# План 132.3 — Durable Background Execution Plane: IPC, projection и UI

Статус: этап 3 для [плана 132.0](./132-0-durable-background-execution-plane.md); issue: [#113](https://github.com/rkfsociety/EvoHime/issues/113).
