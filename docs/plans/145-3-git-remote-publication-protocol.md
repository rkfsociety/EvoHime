# План 145.3 — Git Remote Publication Protocol: IPC, projection и UI

Статус: этап 3 для [плана 145.0](./145-0-git-remote-publication-protocol.md); issue: [#125](https://github.com/rkfsociety/EvoHime/issues/125).
