# План 141.1 — Runtime Service Graph: Core-контракт, schema и storage

Статус: этап 1 для [плана 141.0](./141-0-runtime-service-graph.md); issue: [#122](https://github.com/rkfsociety/EvoHime/issues/122).
