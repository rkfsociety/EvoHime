# План 142.3 — Agent Program Optimizer: IPC, projection и UI

Статус: этап 3 для [плана 142.0](./142-0-agent-program-optimizer.md); issue: [#123](https://github.com/rkfsociety/EvoHime/issues/123).
