# План 168.3 — Hardware Fit Evidence Catalog

Статус: этап 3 для [плана 168.0](./168-0-hardware-fit-evidence-catalog.md); issue: [#148](https://github.com/rkfsociety/EvoHime/issues/148).
