# План 148.3 — Deterministic Review Execution Plan: IPC, projection и UI

Статус: этап 3 для [плана 148.0](./148-0-deterministic-review-execution-plan.md); issue: [#128](https://github.com/rkfsociety/EvoHime/issues/128).
