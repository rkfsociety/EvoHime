# План 140.3 — Authorized Security Assessment Lane: IPC, projection и UI

Статус: этап 3 для [плана 140.0](./140-0-authorized-security-assessment-lane.md); issue: [#121](https://github.com/rkfsociety/EvoHime/issues/121).
