# План 169.0 — Agent Client Protocol Bridge

Статус: предложено по [issue #149](https://github.com/rkfsociety/EvoHime/issues/149). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Agent Client Protocol Bridge должен стать Core-owned, versioned и revision-aware capability в локальном Windows desktop-продукте EvoHime. External Coding Agent Adapter остаётся владельцем supervised external-agent lifecycle; новый слой добавляет standard ACP transport, capability-safe interop и subscription-backed sessions без scraping credentials или второго agent runtime.
...
- [Этап 1 — Core-контракт, schema и storage](./169-1-agent-client-protocol-bridge.md)
- [Этап 2 — runtime-интеграция и recovery](./169-2-agent-client-protocol-bridge.md)
- [Этап 3 — IPC, projection и UI](./169-3-agent-client-protocol-bridge.md)
- [Этап 4 — verification, release evidence и закрытие](./169-4-agent-client-protocol-bridge.md)
...
- [#149 Agent Client Protocol Bridge](https://github.com/rkfsociety/EvoHime/issues/149)
