# Этап 02.4: Embeddings как опциональный слой
...
Блокирующие: этап 02.2 (lexical retrieval, поверх которого строится hybrid) и
...
Hybrid retrieval поверх 02.2 с автоматическим откатом к FTS5.
