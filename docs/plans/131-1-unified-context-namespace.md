# План 131.1 — Unified Context Namespace: Core-контракт, schema и storage

Статус: этап 1 для [плана 131.0](./131-0-unified-context-namespace.md); issue: [#112](https://github.com/rkfsociety/EvoHime/issues/112).
