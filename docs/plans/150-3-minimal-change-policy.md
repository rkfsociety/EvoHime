# План 150.3 — Minimal Change Policy: IPC, projection и UI

Статус: этап 3 для [плана 150.0](./150-0-minimal-change-policy.md); issue: [#130](https://github.com/rkfsociety/EvoHime/issues/130).
