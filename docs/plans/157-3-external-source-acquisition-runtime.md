# План 157.3 — External Source Acquisition Runtime: IPC, projection и UI

Статус: этап 3 для [плана 157.0](./157-0-external-source-acquisition-runtime.md); issue: [#137](https://github.com/rkfsociety/EvoHime/issues/137).
