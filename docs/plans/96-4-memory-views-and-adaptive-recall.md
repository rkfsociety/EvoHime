# План 96.4 — Memory Views & Adaptive Recall: hierarchical scopes, read-only slices и composite retrieval: verification, release-evidence и закрытие

Статус: этап 4 для [плана 96.0](./96-0-memory-views-and-adaptive-recall.md); после [плана 96.3](./96-3-memory-views-and-adaptive-recall.md).
...
- План 96.3 — Core, IPC и client projection.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/76)
