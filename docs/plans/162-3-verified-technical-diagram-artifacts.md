# План 162.3 — Verified Technical Diagram Artifacts: IPC, projection и UI

Статус: этап 3 для [плана 162.0](./162-0-verified-technical-diagram-artifacts.md); issue: [#142](https://github.com/rkfsociety/EvoHime/issues/142).
