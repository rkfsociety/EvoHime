# План 158.3 — Temporal Signal Intelligence: IPC, projection и UI

Статус: этап 3 для [плана 158.0](./158-0-temporal-signal-intelligence.md); issue: [#138](https://github.com/rkfsociety/EvoHime/issues/138).
