...
- [Этап 1 — Core-контракт, schema и storage](./139-1-kernel-capability-facade.md)
- [Этап 2 — runtime-интеграция и recovery](./139-2-kernel-capability-facade.md)
- [Этап 3 — IPC, projection и UI](./139-3-kernel-capability-facade.md)
- [Этап 4 — verification, release evidence и закрытие](./139-4-kernel-capability-facade.md)
...
- [#120 Kernel Capability Facade](https://github.com/rkfsociety/EvoHime/issues/120)
