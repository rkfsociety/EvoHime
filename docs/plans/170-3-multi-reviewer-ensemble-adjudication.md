# План 170.3 — Multi-Reviewer Ensemble & Adjudication

Статус: этап 3 для [плана 170.0](./170-0-multi-reviewer-ensemble-adjudication.md); issue: [#150](https://github.com/rkfsociety/EvoHime/issues/150).
