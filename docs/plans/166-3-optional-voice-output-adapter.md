# План 166.3 — Optional Voice Output Adapter

Статус: этап 3 для [плана 166.0](./166-0-optional-voice-output-adapter.md); issue: [#146](https://github.com/rkfsociety/EvoHime/issues/146).
