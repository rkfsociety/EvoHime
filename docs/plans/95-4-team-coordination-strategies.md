# План 95.4 — Team Coordination Strategies: pluggable selector, round-robin, swarm и graph routing: verification, release-evidence и закрытие

Статус: этап 4 для [плана 95.0](./95-0-team-coordination-strategies.md); после [плана 95.3](./95-3-team-coordination-strategies.md).
...
- План 95.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `95-0` … `95-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/75)
