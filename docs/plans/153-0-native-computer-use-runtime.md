# План 153.0 — Native Computer-Use Runtime

Статус: предложено по [issue #133](https://github.com/rkfsociety/EvoHime/issues/133). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Native Computer-Use Runtime** как versioned/revision-aware capability поверх существующей архитектуры EvoHime. Контур должен иметь bounded contract, одного владельца состояния, безопасные transitions, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./153-1-native-computer-use-runtime.md)
- [Этап 2 — runtime-интеграция и recovery](./153-2-native-computer-use-runtime.md)
- [Этап 3 — IPC, projection и UI](./153-3-native-computer-use-runtime.md)
- [Этап 4 — verification, release evidence и закрытие](./153-4-native-computer-use-runtime.md)
...
- [#133 Native Computer-Use Runtime](https://github.com/rkfsociety/EvoHime/issues/133)
