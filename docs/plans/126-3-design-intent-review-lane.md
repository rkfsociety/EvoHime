# План 126.3 — Design Intent Review Lane: IPC, projection и UI

Статус: этап 3 для [плана 126.0](./126-0-design-intent-review-lane.md); issue: [#107](https://github.com/rkfsociety/EvoHime/issues/107).
