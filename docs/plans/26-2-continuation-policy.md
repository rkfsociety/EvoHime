# План 26.2 — Continuation Policy и quality gates: runtime-интеграция и recovery

Статус: самостоятельный этап 2 для [плана 26.0](./26-0-continuation-policy.md); начинается после [плана 26.1](./26-1-continuation-policy.md).

## Цель

Подключить контракт «Continuation Policy и quality gates» к Core runtime одним вертикальным срезом: validated request -> policy/capability/approval -> bounded execution -> typed result/event -> recovery.
