# План 143.1 — Project Knowledge Notebook: Core-контракт, schema и storage

Статус: этап 1 для [плана 143.0](./143-0-project-knowledge-notebook.md); issue: [#124](https://github.com/rkfsociety/EvoHime/issues/124).
