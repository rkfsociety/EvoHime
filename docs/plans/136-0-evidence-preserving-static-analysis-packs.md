# План 136.0 — Evidence-Preserving Static Analysis Packs

Статус: предложено по [issue #117](https://github.com/rkfsociety/EvoHime/issues/117). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Evidence-Preserving Static Analysis Packs** как отдельный versioned/revision-aware слой поверх существующей архитектуры EvoHime. Он должен иметь bounded контракт, явного владельца состояния, проверяемые переходы, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./136-1-evidence-preserving-static-analysis-packs.md)
- [Этап 2 — runtime-интеграция и recovery](./136-2-evidence-preserving-static-analysis-packs.md)
- [Этап 3 — IPC, projection и UI](./136-3-evidence-preserving-static-analysis-packs.md)
- [Этап 4 — verification, release evidence и закрытие](./136-4-evidence-preserving-static-analysis-packs.md)
...
- [#117 Evidence-Preserving Static Analysis Packs](https://github.com/rkfsociety/EvoHime/issues/117)
