# План 156.3 — Cross-Modal UI Grounding: IPC, projection и UI

Статус: этап 3 для [плана 156.0](./156-0-cross-modal-ui-grounding.md); issue: [#136](https://github.com/rkfsociety/EvoHime/issues/136).
