# План 155.3 — Mobile Device Automation Runtime: IPC, projection и UI

Статус: этап 3 для [плана 155.0](./155-0-mobile-device-automation-runtime.md); issue: [#135](https://github.com/rkfsociety/EvoHime/issues/135).
