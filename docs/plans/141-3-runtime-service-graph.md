# План 141.3 — Runtime Service Graph: IPC, projection и UI

Статус: этап 3 для [плана 141.0](./141-0-runtime-service-graph.md); issue: [#122](https://github.com/rkfsociety/EvoHime/issues/122).
