# План 139.2 — Kernel Capability Facade: runtime-интеграция и recovery

Статус: этап 2 для [плана 139.0](./139-0-kernel-capability-facade.md); issue: [#120](https://github.com/rkfsociety/EvoHime/issues/120).

## Зависимости

### Блокирующие

- План 139.0 и предыдущий этап этого направления.
