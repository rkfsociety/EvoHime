# План 129.3 — Confidence-Gated Model Cascade: IPC, projection и UI

Статус: этап 3 для [плана 129.0](./129-0-confidence-gated-model-cascade.md); issue: [#110](https://github.com/rkfsociety/EvoHime/issues/110).
