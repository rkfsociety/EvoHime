# План 92.4 — Privacy & Telemetry Governance: consent, typed analytics events и sensitive-data boundaries: verification, release-evidence и закрытие

Статус: этап 4 для [плана 92.0](./92-0-privacy-and-telemetry-governance.md); после [плана 92.3](./92-3-privacy-and-telemetry-governance.md).
...
- План 92.3 — Core, IPC и client projection.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/72)
