# План 137.1 — Agent Context Loadouts: Core-контракт, schema и storage

Статус: этап 1 для [плана 137.0](./137-0-agent-context-loadouts.md); issue: [#118](https://github.com/rkfsociety/EvoHime/issues/118).
