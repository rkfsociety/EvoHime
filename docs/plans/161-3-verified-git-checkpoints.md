# План 161.3 — Verified Git Checkpoints: IPC, projection и UI

Статус: этап 3 для [плана 161.0](./161-0-verified-git-checkpoints.md); issue: [#141](https://github.com/rkfsociety/EvoHime/issues/141).
