# План 152.0 — Autonomous Metric Experiment Runtime

Статус: предложено по [issue #132](https://github.com/rkfsociety/EvoHime/issues/132). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Autonomous Metric Experiment Runtime** как versioned/revision-aware capability поверх существующей архитектуры EvoHime. Контур должен иметь bounded contract, одного владельца состояния, безопасные transitions, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./152-1-autonomous-metric-experiment-runtime.md)
- [Этап 2 — runtime-интеграция и recovery](./152-2-autonomous-metric-experiment-runtime.md)
- [Этап 3 — IPC, projection и UI](./152-3-autonomous-metric-experiment-runtime.md)
- [Этап 4 — verification, release evidence и закрытие](./152-4-autonomous-metric-experiment-runtime.md)
...
- [#132 Autonomous Metric Experiment Runtime](https://github.com/rkfsociety/EvoHime/issues/132)
