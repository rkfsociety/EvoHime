# План 151.3 — Contextual Next-Step Suggestions: IPC, projection и UI

Статус: этап 3 для [плана 151.0](./151-0-contextual-next-step-suggestions.md); issue: [#131](https://github.com/rkfsociety/EvoHime/issues/131).
