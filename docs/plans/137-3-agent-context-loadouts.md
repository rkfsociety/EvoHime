# План 137.3 — Agent Context Loadouts: IPC, projection и UI

Статус: этап 3 для [плана 137.0](./137-0-agent-context-loadouts.md); issue: [#118](https://github.com/rkfsociety/EvoHime/issues/118).
