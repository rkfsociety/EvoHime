# План 159.1 — Temporal Memory Facts: Core-контракт, schema и storage

Статус: этап 1 для [плана 159.0](./159-0-temporal-memory-facts.md); issue: [#139](https://github.com/rkfsociety/EvoHime/issues/139).

## Зависимости

### Блокирующие

- План 159.0 и предыдущий этап этого направления.
