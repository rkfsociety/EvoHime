...
При расхождении этого плана с реализацией сначала обновляется статус на основании кода и тестов. Все планы лежат в каталоге `docs/plans/`: исполняемый цикл — здесь, долгосрочные направления — в [`roadmap.md`](roadmap.md).
