# План 145.2 — Git Remote Publication Protocol: runtime-интеграция и recovery

Статус: этап 2 для [плана 145.0](./145-0-git-remote-publication-protocol.md); issue: [#125](https://github.com/rkfsociety/EvoHime/issues/125).
