# План 149.3 — Interactive Model Compare Workbench: IPC, projection и UI

Статус: этап 3 для [плана 149.0](./149-0-interactive-model-compare-workbench.md); issue: [#129](https://github.com/rkfsociety/EvoHime/issues/129).
