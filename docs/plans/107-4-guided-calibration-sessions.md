# План 107.4 — Guided Calibration Sessions: iterative human feedback и versioned role guidance: verification, release-evidence и закрытие

Статус: этап 4 для [плана 107.0](./107-0-guided-calibration-sessions.md); после [плана 107.3](./107-3-guided-calibration-sessions.md).
...
- План 107.3 — Core, IPC и client projection.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/87)
