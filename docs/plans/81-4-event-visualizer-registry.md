# План 81.4 — Event Visualizer Registry: typed renderers для tool, workflow и artifact events: verification, release-evidence и закрытие

Статус: этап 4 для [плана 81.0](./81-0-event-visualizer-registry.md); после [плана 81.3](./81-3-event-visualizer-registry.md).
...
- План 81.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `81-0` … `81-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/61)
