# План 106.4 — Declarative Runtime Components: versioned component config, provider registry и safe rehydration: verification, release-evidence и закрытие

Статус: этап 4 для [плана 106.0](./106-0-declarative-runtime-components.md); после [плана 106.3](./106-3-declarative-runtime-components.md).
...
- План 106.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `106-0` … `106-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/86)
