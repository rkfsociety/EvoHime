# План 151.0 — Contextual Next-Step Suggestions

Статус: предложено по [issue #131](https://github.com/rkfsociety/EvoHime/issues/131). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Contextual Next-Step Suggestions** как versioned/revision-aware capability поверх существующей архитектуры EvoHime. Контур должен иметь bounded contract, одного владельца состояния, безопасные transitions, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./151-1-contextual-next-step-suggestions.md)
- [Этап 2 — runtime-интеграция и recovery](./151-2-contextual-next-step-suggestions.md)
- [Этап 3 — IPC, projection и UI](./151-3-contextual-next-step-suggestions.md)
- [Этап 4 — verification, release evidence и закрытие](./151-4-contextual-next-step-suggestions.md)
...
- [#131 Contextual Next-Step Suggestions](https://github.com/rkfsociety/EvoHime/issues/131)
