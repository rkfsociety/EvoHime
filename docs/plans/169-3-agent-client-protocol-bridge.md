# План 169.3 — Agent Client Protocol Bridge

Статус: этап 3 для [плана 169.0](./169-0-agent-client-protocol-bridge.md); issue: [#149](https://github.com/rkfsociety/EvoHime/issues/149).
