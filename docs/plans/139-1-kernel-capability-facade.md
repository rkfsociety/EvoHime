# План 139.1 — Kernel Capability Facade: Core-контракт, schema и storage

Статус: этап 1 для [плана 139.0](./139-0-kernel-capability-facade.md); issue: [#120](https://github.com/rkfsociety/EvoHime/issues/120).
