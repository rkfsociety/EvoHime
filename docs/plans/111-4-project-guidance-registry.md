# План 111.4 — Project Guidance Registry: scoped coding conventions и read-only instruction layers: verification, release-evidence и закрытие

Статус: этап 4 для [плана 111.0](./111-0-project-guidance-registry.md); после [плана 111.3](./111-3-project-guidance-registry.md).
...
- План 111.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `111-0` … `111-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/91)
