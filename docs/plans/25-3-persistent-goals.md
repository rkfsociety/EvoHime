# План 25.3 — Persistent Goals для длительных задач: IPC, client projection и UI

Статус: самостоятельный этап 3 для [плана 25.0](./25-0-persistent-goals.md); начинается после [плана 25.2](./25-2-persistent-goals.md).
...
- План 25.2 — работающий Core vertical slice, recovery и список стабильных команд/events.
