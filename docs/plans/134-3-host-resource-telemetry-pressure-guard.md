# План 134.3 — Host Resource Telemetry & Pressure Guard: IPC, projection и UI

Статус: этап 3 для [плана 134.0](./134-0-host-resource-telemetry-pressure-guard.md); issue: [#115](https://github.com/rkfsociety/EvoHime/issues/115).
