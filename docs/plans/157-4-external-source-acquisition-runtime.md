# План 157.4 — External Source Acquisition Runtime: verification, release evidence и закрытие

Статус: этап 4 для [плана 157.0](./157-0-external-source-acquisition-runtime.md); issue: [#137](https://github.com/rkfsociety/EvoHime/issues/137).
