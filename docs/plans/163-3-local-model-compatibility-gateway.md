# План 163.3 — Local Model Compatibility Gateway: IPC, projection и UI

Статус: этап 3 для [плана 163.0](./163-0-local-model-compatibility-gateway.md); issue: [#143](https://github.com/rkfsociety/EvoHime/issues/143).
