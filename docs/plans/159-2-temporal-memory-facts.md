# План 159.2 — Temporal Memory Facts: runtime-интеграция и recovery

Статус: этап 2 для [плана 159.0](./159-0-temporal-memory-facts.md); issue: [#139](https://github.com/rkfsociety/EvoHime/issues/139).
