# План 136.1 — Evidence-Preserving Static Analysis Packs: Core-контракт, schema и storage

Статус: этап 1 для [плана 136.0](./136-0-evidence-preserving-static-analysis-packs.md); issue: [#117](https://github.com/rkfsociety/EvoHime/issues/117).
