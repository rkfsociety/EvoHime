# План 160.1 — IDE Companion Bridge: Core-контракт, schema и storage

Статус: этап 1 для [плана 160.0](./160-0-ide-companion-bridge.md); issue: [#140](https://github.com/rkfsociety/EvoHime/issues/140).
