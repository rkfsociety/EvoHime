# План 135.3 — Code Review Lane: IPC, projection и UI

Статус: этап 3 для [плана 135.0](./135-0-code-review-lane.md); issue: [#116](https://github.com/rkfsociety/EvoHime/issues/116).
