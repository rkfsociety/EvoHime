...
Планы 01–06, 08, 09, 16 и 17 реализованы целиком и удалены из каталога: их
контракты и подтверждённое состояние живут в canonical документах.
План 07 остаётся отдельным предложенным направлением без исполняемого файла.
...
Планы 16 и 17 завершены последовательно: 16-1 → 16-2 → 16-3 → 16-4 и
17-1 → 17-2 → 17-3 → 17-4. Их контракты и граф зависимостей перенесены в
canonical документы.
