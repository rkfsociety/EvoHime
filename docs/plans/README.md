...
Планы 01–22 завершены и удалены после реализации. В каталоге нет активного
плана: новый план создаётся только после evidence review и получает следующий
свободный номер.
...
Планы 01–21 реализованы и перенесены в канонические разделы
[`../architecture.md`](../architecture.md) и [`../current-state.md`](../current-state.md).
План 21 реализован и перенесён в канонические документы; план 22 является
текущим незавершённым циклом.
