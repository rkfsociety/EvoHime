...
Планы 01–25 и 33–34 завершены и удалены после реализации. Для каждого незавершённого
направления 26–32 и 35–115 существует обзорный файл `NN-0-slug.md` и четыре самостоятельных файла
