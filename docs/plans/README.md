...
Планы 01–21 завершены и удалены после реализации. Новые планы добавляются
...
План 21.1–21.4 реализован и перенесён в канонические документы; временные файлы направления удалены после проверок.
