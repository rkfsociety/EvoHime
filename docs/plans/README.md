...
| 17 Общие release gates и нерешённые решения | 17.3 реализован; rollback/evidence/license contract перенесён в [`../release-evidence.md`](../release-evidence.md) | 17-4 от 17-3 |
