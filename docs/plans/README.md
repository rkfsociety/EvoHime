...
Планы 01–19 завершены и удалены после реализации. Новые планы добавляются
...
Направление 20 — визуальная переработка Electron UI:

- [`20-0-electron-ui-visual-redesign.md`](20-0-electron-ui-visual-redesign.md) —
  утверждённая спецификация и общий контракт;
- `20-1`–`20-5` — последовательные этапы реализации оболочки, проектов,
  чата, панелей, настроек и overlays;
- `20-6` — финальная проверка и передача UI.

Этапы готовы к отдельному ревью и реализации по порядку. План 19.0 завершён.
