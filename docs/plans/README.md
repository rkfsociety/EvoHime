...
Обновлено: 2026-09-26. Наличие комплекта `NN-0` ... `NN-4` означает, что
...
и evidence в канонические документы. К закрытым относятся планы `01–178` и `183`
...
Незавершённые numbered plans: 179–181 и 184–188.
...
зависимостей; следующий номер — `189`, текущий active catalog — `179–181` и
`184–188`.
