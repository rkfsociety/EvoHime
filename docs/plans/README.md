...
Планы 01–17 завершены и удалены после реализации. В каталоге сейчас находится
обзор плана 18 — текущего этапа закрытия release blockers. Новые планы
добавляются сюда только после ревью.
...
- [`18-0-release-blockers.md`](18-0-release-blockers.md) — scheduler/IPC,
  automation archive/restore, license inventory и code signing.
