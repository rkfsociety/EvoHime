...
документы. Текущий незавершённый диапазон начинается с плана 61.
...
План 60 закрыт после реализации и переноса Revision-Safe Workspace Files в
канонические документы; текущий незавершённый диапазон начинается с плана 61.
