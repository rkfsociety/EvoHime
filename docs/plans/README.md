...
направления 26–32, 37 и 40–115 существует обзорный файл `NN-0-slug.md` и четыре самостоятельных файла
...
Направления 33–43 закрыты и исключены из списка незавершённых планов.
