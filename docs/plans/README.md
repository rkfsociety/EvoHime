...
и evidence в канонические документы. К закрытым относятся планы `01–176` и `183`
...
Незавершённые numbered plans: 177–181 и 184–188.
...
зависимостей; следующий номер — `189`, текущий active catalog — `177–181` и
`184–188`.
