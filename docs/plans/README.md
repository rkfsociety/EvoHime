...
направления 50–143 существует обзорный файл `NN-0-slug.md` и четыре самостоятельных файла
...
направление получает следующий свободный номер после 142 и тот же набор
файлов.
