...
незавершённых направлений: сначала план 07, затем планы 15, 16 и 17.
Их обзоры:
...
15-1 → 15-2 → 15-3 → 15-4, затем
16-1 → 16-2 → 16-3 → 16-4 и 17-1 → 17-2 → 17-3 → 17-4. Обзоры 15-0, 16-0 и 17-0 не являются исполняемыми этапами;
