...
направления 50–125 существует обзорный файл `NN-0-slug.md` и четыре самостоятельных файла
...
направление получает следующий свободный номер после 124 и тот же набор
файлов.
