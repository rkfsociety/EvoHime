...
| 06 Agno-inspired workflow orchestration для Евы | проектируется; обзор в [`06-0-workflow-orchestration.md`](06-0-workflow-orchestration.md) | 06-1 зависит от существующих workflow/child contracts; 06-2 от 06-1; 06-3 от 06-2; 06-4 от 06-3 |
