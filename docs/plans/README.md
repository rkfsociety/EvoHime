...
| 17 Общие release gates и нерешённые решения | 17.2 реализован; gates и runtime boundaries перенесены в [`../architecture.md`](../architecture.md) и CI | 17-3 от 17-2; 17-4 от 17-3 |
