...
Планы 01–25 завершены и удалены после реализации. Для каждого незавершённого
направления 26–115 существует обзорный файл `NN-0-slug.md` и четыре самостоятельных файла
