...
и evidence в канонические документы. К закрытым относятся планы `01–177` и `183`
...
Незавершённые numbered plans: 178–181 и 184–188.
...
зависимостей; следующий номер — `189`, текущий active catalog — `178–181` и
`184–188`.
