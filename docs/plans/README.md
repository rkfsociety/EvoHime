...
Планы 01–25 и 33–36 завершены и удалены после реализации. Для каждого незавершённого
направления 26–32 и 37–115 существует обзорный файл `NN-0-slug.md` и четыре самостоятельных файла
...
Направления 33–36 закрыты и исключены из списка незавершённых планов.
