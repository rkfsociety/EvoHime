# План 146.2 — Voice Input & Dictation: runtime-интеграция и recovery

Статус: этап 2 для [плана 146.0](./146-0-voice-input-dictation.md); issue: [#126](https://github.com/rkfsociety/EvoHime/issues/126).
