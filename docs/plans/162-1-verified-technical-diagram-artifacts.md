# План 162.1 — Verified Technical Diagram Artifacts: Core-контракт, schema и storage

Статус: этап 1 для [плана 162.0](./162-0-verified-technical-diagram-artifacts.md); issue: [#142](https://github.com/rkfsociety/EvoHime/issues/142).

## Зависимости

### Блокирующие

- План 162.0 и предыдущий этап этого направления.
...
Определить bounded типы, lifecycle Draft/Active/Superseded/Invalid, canonical hash, scope/actor/revision/idempotency semantics для Verified Technical Diagram Artifacts. Добавить metadata-only transactional storage и additive migration с backup, rollback, corruption/expiry/size limits; зафиксировать ownership и границы с существующими registry/policy/provenance subsystems.
