# План 100.4 — Workspace Sets: multi-root и cross-repository задачи с независимыми grants, VCS и checkpoints: verification, release-evidence и закрытие

Статус: этап 4 для [плана 100.0](./100-0-workspace-sets.md); после [плана 100.3](./100-3-workspace-sets.md).
...
- План 100.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `100-0` … `100-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/80)
