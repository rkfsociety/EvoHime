# План 81.3 — Event Visualizer Registry: typed renderers для tool, workflow и artifact events: IPC, client projection и UI

Статус: этап 3 для [плана 81.0](./81-0-event-visualizer-registry.md); после [плана 81.2](./81-2-event-visualizer-registry.md).
...
- План 81.2 — runtime vertical slice, recovery и стабильные commands/events.
