# План 149.0 — Interactive Model Compare Workbench

Статус: предложено по [issue #129](https://github.com/rkfsociety/EvoHime/issues/129). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Interactive Model Compare Workbench** как versioned/revision-aware capability поверх существующей архитектуры EvoHime. Контур должен иметь bounded contract, одного владельца состояния, безопасные transitions, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./149-1-interactive-model-compare-workbench.md)
- [Этап 2 — runtime-интеграция и recovery](./149-2-interactive-model-compare-workbench.md)
- [Этап 3 — IPC, projection и UI](./149-3-interactive-model-compare-workbench.md)
- [Этап 4 — verification, release evidence и закрытие](./149-4-interactive-model-compare-workbench.md)
...
- [#129 Interactive Model Compare Workbench](https://github.com/rkfsociety/EvoHime/issues/129)
