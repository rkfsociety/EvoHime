# План 150.4 — Minimal Change Policy: verification, release evidence и закрытие

Статус: этап 4 для [плана 150.0](./150-0-minimal-change-policy.md); issue: [#130](https://github.com/rkfsociety/EvoHime/issues/130).
