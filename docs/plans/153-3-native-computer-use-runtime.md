# План 153.3 — Native Computer-Use Runtime: IPC, projection и UI

Статус: этап 3 для [плана 153.0](./153-0-native-computer-use-runtime.md); issue: [#133](https://github.com/rkfsociety/EvoHime/issues/133).
