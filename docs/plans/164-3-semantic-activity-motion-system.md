# План 164.3 — Semantic Activity Motion System

Статус: этап 3 для [плана 164.0](./164-0-semantic-activity-motion-system.md); issue: [#144](https://github.com/rkfsociety/EvoHime/issues/144).
