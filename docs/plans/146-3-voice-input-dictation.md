# План 146.3 — Voice Input & Dictation: IPC, projection и UI

Статус: этап 3 для [плана 146.0](./146-0-voice-input-dictation.md); issue: [#126](https://github.com/rkfsociety/EvoHime/issues/126).
