# План 140.1 — Authorized Security Assessment Lane: Core-контракт, schema и storage

Статус: этап 1 для [плана 140.0](./140-0-authorized-security-assessment-lane.md); issue: [#121](https://github.com/rkfsociety/EvoHime/issues/121).
