# План 135.1 — Code Review Lane: Core-контракт, schema и storage

Статус: этап 1 для [плана 135.0](./135-0-code-review-lane.md); issue: [#116](https://github.com/rkfsociety/EvoHime/issues/116).
