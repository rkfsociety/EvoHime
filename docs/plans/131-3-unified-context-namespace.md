# План 131.3 — Unified Context Namespace: IPC, projection и UI

Статус: этап 3 для [плана 131.0](./131-0-unified-context-namespace.md); issue: [#112](https://github.com/rkfsociety/EvoHime/issues/112).
