# План 133.3 — Built-in Deterministic Developer Utilities: IPC, projection и UI

Статус: этап 3 для [плана 133.0](./133-0-built-in-deterministic-developer-utilities.md); issue: [#114](https://github.com/rkfsociety/EvoHime/issues/114).
