# План 150.2 — Minimal Change Policy: runtime-интеграция и recovery

Статус: этап 2 для [плана 150.0](./150-0-minimal-change-policy.md); issue: [#130](https://github.com/rkfsociety/EvoHime/issues/130).
