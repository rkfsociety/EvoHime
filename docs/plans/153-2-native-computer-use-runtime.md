# План 153.2 — Native Computer-Use Runtime: runtime-интеграция и recovery

Статус: этап 2 для [плана 153.0](./153-0-native-computer-use-runtime.md); issue: [#133](https://github.com/rkfsociety/EvoHime/issues/133).
