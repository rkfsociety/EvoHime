# План 63.4 — Composable Termination Conditions: first-class stop policies for agent and team runs: verification, release-evidence и закрытие

Статус: этап 4 для [плана 63.0](./63-0-composable-termination-conditions.md); после [плана 63.3](./63-3-composable-termination-conditions.md).
...
- План 63.3 — Core, IPC и client projection.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/43)
