# План 128.3 — Local Inference Scheduler: IPC, projection и UI

Статус: этап 3 для [плана 128.0](./128-0-local-inference-scheduler.md); issue: [#109](https://github.com/rkfsociety/EvoHime/issues/109).
