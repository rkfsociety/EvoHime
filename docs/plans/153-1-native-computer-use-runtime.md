# План 153.1 — Native Computer-Use Runtime: Core-контракт, schema и storage

Статус: этап 1 для [плана 153.0](./153-0-native-computer-use-runtime.md); issue: [#133](https://github.com/rkfsociety/EvoHime/issues/133).

## Зависимости

### Блокирующие

- План 153.0 и предыдущий этап этого направления.
...
Определить bounded типы, lifecycle Draft/Active/Superseded/Invalid, canonical hash, scope/actor/revision/idempotency semantics для Native Computer-Use Runtime. Добавить metadata-only transactional storage и additive migration с backup, rollback, corruption/expiry/size limits; зафиксировать ownership и границы с существующими registry/policy/provenance subsystems.
