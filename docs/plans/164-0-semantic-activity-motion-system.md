# План 164.0 — Semantic Activity Motion System

Статус: предложено по [issue #144](https://github.com/rkfsociety/EvoHime/issues/144). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Semantic Activity Motion System** поверх существующей Electron/Rust/SQLite архитектуры EvoHime. Состояние, policy, permissions, recovery и итоговый verdict принадлежат Core; renderer получает только bounded authenticated projection.
...
- [Этап 1 — Core-контракт, schema и storage](./164-1-semantic-activity-motion-system.md)
- [Этап 2 — runtime-интеграция и recovery](./164-2-semantic-activity-motion-system.md)
- [Этап 3 — IPC, projection и UI](./164-3-semantic-activity-motion-system.md)
- [Этап 4 — verification, release evidence и закрытие](./164-4-semantic-activity-motion-system.md)
...
- [#144 Semantic Activity Motion System](https://github.com/rkfsociety/EvoHime/issues/144)
