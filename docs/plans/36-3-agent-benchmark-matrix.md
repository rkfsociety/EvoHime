# План 36.3 — Agent Benchmark Matrix: многократные model/strategy evals и regression tracking: IPC, client projection и UI

Статус: этап 3 для [плана 36.0](./36-0-agent-benchmark-matrix.md); после [плана 36.2](./36-2-agent-benchmark-matrix.md).
...
- План 36.2 — runtime vertical slice, recovery и стабильные commands/events.
