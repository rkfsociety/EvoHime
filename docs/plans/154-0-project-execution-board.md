# План 154.0 — Project Execution Board

Статус: предложено по [issue #134](https://github.com/rkfsociety/EvoHime/issues/134). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Project Execution Board** как versioned/revision-aware capability поверх существующей архитектуры EvoHime. Контур должен иметь bounded contract, одного владельца состояния, безопасные transitions, recovery и metadata-only Electron projection. Renderer не получает authority над runtime, workspace, SQLite, secrets или policy.
...
- [Этап 1 — Core-контракт, schema и storage](./154-1-project-execution-board.md)
- [Этап 2 — runtime-интеграция и recovery](./154-2-project-execution-board.md)
- [Этап 3 — IPC, projection и UI](./154-3-project-execution-board.md)
- [Этап 4 — verification, release evidence и закрытие](./154-4-project-execution-board.md)
...
- [#134 Project Execution Board](https://github.com/rkfsociety/EvoHime/issues/134)
