# План 161.2 — Verified Git Checkpoints: runtime-интеграция и recovery

Статус: этап 2 для [плана 161.0](./161-0-verified-git-checkpoints.md); issue: [#141](https://github.com/rkfsociety/EvoHime/issues/141).
