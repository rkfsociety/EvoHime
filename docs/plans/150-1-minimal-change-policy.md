# План 150.1 — Minimal Change Policy: Core-контракт, schema и storage

Статус: этап 1 для [плана 150.0](./150-0-minimal-change-policy.md); issue: [#130](https://github.com/rkfsociety/EvoHime/issues/130).

## Зависимости

### Блокирующие

- План 150.0 и предыдущий этап этого направления.
