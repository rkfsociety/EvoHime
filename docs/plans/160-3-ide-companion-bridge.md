# План 160.3 — IDE Companion Bridge: IPC, projection и UI

Статус: этап 3 для [плана 160.0](./160-0-ide-companion-bridge.md); issue: [#140](https://github.com/rkfsociety/EvoHime/issues/140).
