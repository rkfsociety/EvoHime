# План 101.4 — Knowledge Source Registry: project/role RAG, source provenance и indexed reference context: verification, release-evidence и закрытие

Статус: этап 4 для [плана 101.0](./101-0-knowledge-source-registry-project-role.md); после [плана 101.3](./101-3-knowledge-source-registry-project-role.md).
...
- План 101.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `101-0` … `101-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/81)
