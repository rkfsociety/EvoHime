# План 165.0 — Domain Workflow Recipes

Статус: предложено по [issue #145](https://github.com/rkfsociety/EvoHime/issues/145). Это implementation contract; функционал этим документом не считается реализованным.

## Цель

Реализовать Core-owned контур **Domain Workflow Recipes** поверх существующей Electron/Rust/SQLite архитектуры EvoHime. Состояние, policy, permissions, recovery и итоговый verdict принадлежат Core; renderer получает только bounded authenticated projection.
...
- [Этап 1 — Core-контракт, schema и storage](./165-1-domain-workflow-recipes.md)
- [Этап 2 — runtime-интеграция и recovery](./165-2-domain-workflow-recipes.md)
- [Этап 3 — IPC, projection и UI](./165-3-domain-workflow-recipes.md)
- [Этап 4 — verification, release evidence и закрытие](./165-4-domain-workflow-recipes.md)
...
- [#145 Domain Workflow Recipes](https://github.com/rkfsociety/EvoHime/issues/145)
