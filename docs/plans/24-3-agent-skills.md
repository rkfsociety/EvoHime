# План 24.3 — Agent Skills registry и progressive disclosure: IPC, client projection и UI

Статус: самостоятельный этап 3 для [плана 24.0](./24-0-agent-skills.md); начинается после [плана 24.2](./24-2-agent-skills.md).
...
- План 24.2 — работающий Core vertical slice, recovery и список стабильных команд/events.
