# План 159.3 — Temporal Memory Facts: IPC, projection и UI

Статус: этап 3 для [плана 159.0](./159-0-temporal-memory-facts.md); issue: [#139](https://github.com/rkfsociety/EvoHime/issues/139).
