# План 139.4 — Kernel Capability Facade: verification, release evidence и закрытие

Статус: этап 4 для [плана 139.0](./139-0-kernel-capability-facade.md); issue: [#120](https://github.com/rkfsociety/EvoHime/issues/120).
