# План 146.1 — Voice Input & Dictation: Core-контракт, schema и storage

Статус: этап 1 для [плана 146.0](./146-0-voice-input-dictation.md); issue: [#126](https://github.com/rkfsociety/EvoHime/issues/126).

## Зависимости

### Блокирующие

- План 146.0 и предыдущий этап этого направления.
