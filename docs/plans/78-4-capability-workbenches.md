# План 78.4 — Capability Workbenches: lifecycle-scoped tool groups with shared state and resources: verification, release-evidence и закрытие

Статус: этап 4 для [плана 78.0](./78-0-capability-workbenches.md); после [плана 78.3](./78-3-capability-workbenches.md).
...
- План 78.3 — Core, IPC и client projection.
...
- После закрытия всего направления и переноса подтверждённого контракта удалить комплект `78-0` … `78-4`; отдельные stage-файлы до этого не удалять. Незавершённое направление оставить blocked с evidence.
...
- [issue](https://github.com/rkfsociety/EvoHime/issues/58)
