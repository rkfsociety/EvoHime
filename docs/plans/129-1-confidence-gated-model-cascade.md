# План 129.1 — Confidence-Gated Model Cascade: Core-контракт, schema и storage

Статус: этап 1 для [плана 129.0](./129-0-confidence-gated-model-cascade.md); issue: [#110](https://github.com/rkfsociety/EvoHime/issues/110).
