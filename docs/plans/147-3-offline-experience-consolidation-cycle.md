# План 147.3 — Offline Experience Consolidation Cycle: IPC, projection и UI

Статус: этап 3 для [плана 147.0](./147-0-offline-experience-consolidation-cycle.md); issue: [#127](https://github.com/rkfsociety/EvoHime/issues/127).
