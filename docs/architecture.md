...
глобальным инструментам нет. Разделы «Обзор», «Ревью планов», «Память и
Pulse», «Составные задачи» и «Слух», а также «Настройки» открываются из
выпадающего меню пользователя вверх.
