...
контекста; поле задачи содержит прикрепление файлов, переключатель веб-поиска и
отправку. Клавиатурные подсказки и состояние Core находятся в тонком футере.
