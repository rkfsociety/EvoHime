...
остаётся видимым при запуске: `UpdateGate` не показывает рабочую оболочку до
завершения startup-проверки обновления, но renderer отображает этот экран, а
не отправляет Еву сразу в трей.
