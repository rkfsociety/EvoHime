...
| D-RELEASE-01 | Единственный релиз `installer` — маленький web installer; после запуска он получает точные module releases через compatibility manifest | Release | `installer/release-notes.md`, bootstrap installer workflow |
