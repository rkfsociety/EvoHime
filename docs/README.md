...
Планы отдельных направлений живут в каталоге [`plans/`](plans/); их порядок, граф зависимостей и правило нумерации описаны в [`plans/README.md`](plans/README.md). Номер файла задаёт порядок реализации: план может блокирующе зависеть только от планов с меньшим номером.
