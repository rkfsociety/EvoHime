...
Планы и их ревью находятся в [`plans/`](plans/). Numbered-подпланы `1-`…`5-` содержат исполняемые незавершённые работы в порядке возрастания сложности; порядок и зависимости указаны в начале каждого файла. На текущем этапе это рабочая зона: не трактуйте её документы как замену фактическому состоянию и не редактируйте без отдельного запроса.
