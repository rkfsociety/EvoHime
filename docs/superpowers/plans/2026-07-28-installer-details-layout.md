...
- [x] **Шаг 1: Запустить форматирование, тесты и компиляцию из актуального исходного кода**
...
- [x] **Шаг 2: Проверить Windows GUI subsystem**
...
- [x] **Шаг 3: Запустить и визуально проверить начальное окно**
...
Фактическая визуальная приёмка release-бинарника подтвердила внешний размер
окна `902×752` с рамкой Windows, то есть клиентскую область `900×720`,
постоянный заголовок подробностей, заглушку пустого журнала, отключённую кнопку
копирования и отсутствие перекрытий. Текущий Windows helper не смог надёжно
захватить невидимую внешнюю resize-рамку окна; минимальный размер и заполнение
при изменении обеих осей дополнительно подтверждены точными значениями
`ViewportBuilder` и автоматизированным layout-тестом. «Установить» во время
визуальной проверки не нажималась.

- [x] **Шаг 4: Проверить заполненный журнал автоматизированным UI-покрытием**
...
- [x] **Шаг 5: Проверить финальный diff и удалить артефакты сборки**
...
- [x] **Шаг 6: Зафиксировать результат проверки без пустого коммита**
