...
**Актуальный статус 2026-07-22:** `7.71` ✅ — каждая активная панель и Settings modal изолированы Error Boundary с retry fallback; следующий — `7.87` (fmt/docs gates).
...
5. **Wave E (DX/CI):** `7.84`–`7.86` ✅, `7.56`, `7.69`–`7.71` ✅ → next `7.87`
