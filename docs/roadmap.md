...
**Актуальный статус 2026-07-22:** `7.89` ✅ — route-level OpenAPI и typed path union генерируются из `routes.rs`; следующий — `7.90` (feature flags).
...
5. **Wave E (DX/CI):** `7.84`–`7.89` ✅, `7.56`, `7.69`–`7.71` ✅ → next `7.90`
