...
Текущий активный каталог — планы `136–143` и `145–167`; блокирующие и
...
| 136–143 | evidence packs, loadouts, skills, capability, security, service graph, optimizer, notebook | активная очередь по графу |
