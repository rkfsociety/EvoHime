...
из `docs/plans` по следующему номеру.
План 66 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 67 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 68 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 69 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 70 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 71 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 72 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 75 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
План 76 закрыт 2 сентября 2026 года. Следующий незавершённый этап выбирается
из `docs/plans` по следующему номеру.
