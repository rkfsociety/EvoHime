...
план 11 (typed memory и Core-first RAG) также реализован; следующим исполняемым
блоком остаётся план 12.
...
независимое направление — план 12. План 07 остаётся отдельным предложенным
