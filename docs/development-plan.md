...
Текущий активный каталог — планы `148–167`; блокирующие и
...
| 148–167 | review, model compare, policy, suggestions, experiments, computer use, execution board, grounding, temporal memory, IDE, checkpoints, diagrams, compatibility, motion, recipes, voice output, command center | активная очередь по графу |

Планы 01–147 и 144 закрыты и удалены из временного каталога после переноса
