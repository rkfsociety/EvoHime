...
Текущий активный каталог — планы `142–143` и `145–167`; блокирующие и
...
| 142–143 | optimizer, notebook | следующая очередь по графу |
...
Планы 01–141 и 144 закрыты и удалены из временного каталога после переноса
