...
Текущий активный каталог — план `143` и `145–167`; блокирующие и
...
| 143 | notebook | следующая очередь по графу |
...
Планы 01–142 и 144 закрыты и удалены из временного каталога после переноса
