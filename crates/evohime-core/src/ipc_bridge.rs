...
impl IpcBridge {
    ...
    async fn dispatch_workspace_state_checkpoint(
        &self,
        operation: String,
    ...
    async fn dispatch_incremental_change_protocol(
        &self,
        operation: String,
    ...
    async fn dispatch_team_coordination_policies(
        &self,
        operation: String,
    ...
    async fn dispatch_schema_driven_agent_configuration(
        &self,
        operation: String,
    ...
    async fn dispatch_workflow_optimization_lab(
        &self,
        operation: String,
    ...
    async fn dispatch_dependency_aware_task_graph(
        &self,
        operation: String,
    ...
    async fn dispatch_knowledge_source_registry(
        &self,
        operation: String,
    ...
    async fn dispatch_event_visualizer_registry(
        &self,
        operation: String,
    ...
    async fn dispatch_reasoning_operator_library(
        &self,
        operation: String,
    ...
    async fn dispatch_customization_inventory(
        &self,
        operation: String,
    ...
    async fn dispatch_approval_policy_profiles(
        &self,
        operation: String,
    ...
    async fn dispatch_conversation_bridge_adapters(
        &self,
        operation: String,
    ...
    async fn dispatch_declarative_runtime_components(
        &self,
        operation: String,
    ...
    async fn dispatch_extension_conformance_kit(
        &self,
        operation: String,
    ...
    async fn dispatch_model_edit_protocol_registry(
        &self,
        operation: String,
    ...
    async fn dispatch_experience_replay_library(
        &self,
        operation: String,
...
impl IpcBridge {
    async fn dispatch_artifact_handoff_registry(
        &self,
    ...
    async fn write_artifact_handoff_registry_response<W: AsyncWrite + Unpin>(
        &self,
        writer: &mut W,
        payload: Vec<u8>,
    ) -> Result<(), IpcBridgeError> {
