...
//!
//! Этот файл намеренно не подключён к crate до этапа интеграции. Контракт не
//! содержит операций редактирования: новая версия графа создаётся целиком, а
//! уже запущенный граф остаётся неизменяемым.
