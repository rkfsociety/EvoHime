...
pub use extract::{
    experience_patterns, extract_candidates, heuristic_extract, is_ephemeral_task_dump,
    is_transient_infra_failure, parse_extraction_json, ExtractedCandidate, MAX_CANDIDATES_PER_TASK,
};
pub use feedback::{
