...
export interface ProjectInstructionStackProjection {
  readonly schemaVersion: number
...
export interface MessageInterventionPoliciesProjection {
  readonly schemaVersion: number
  readonly operation: string
  readonly version: number
  readonly status: string
...
export const RENDERER_COMMANDS = [
  ...
  'core.authorizedSecurityAssessment',
  'core.runtimeServiceGraph',
  'core.agentProgramOptimizer',
  'core.projectKnowledgeNotebook',
  'core.gitRemotePublicationProtocol',
  'core.voiceInputDictation',
  'core.offlineExperienceConsolidation',
...
export interface CommandPayloads {
  ...
  'core.extensionConformanceKit': { operation: 'run' | 'register' | 'inspect'; subjectId: string; payload: string; expectedVersion?: number; idempotencyKey: string }
  ...
  'core.agentProgramOptimizer': { operation: 'save' | 'get' | 'optimize' | 'pin' | 'activate' | 'supersede'; programId: string; payload: string; expectedRevision?: number; idempotencyKey: string }
  ...
  'core.knowledgeSourceRegistry': { operation: 'register' | 'get' | 'bind' | 'index' | 'retrieve' | 'collection_register' | 'collection_get' | 'collection_view' | 'research_revision' | 'research_evidence_item' | 'research_session' | 'research_session_run' | 'research_artifact' | 'research_artifact_get' | 'research_delta' | 'research_artifact_promote' | 'research_session_transition'; sourceId: string; payload?: string; expectedVersion?: number; idempotencyKey?: string }
...
export interface CommandResults {
  ...
  'core.extensionConformanceKit': { accepted: boolean }
  ...
  'core.agentProgramOptimizer': { accepted: boolean }
