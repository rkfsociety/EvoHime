...
export interface CommandPayloads {
  ...
  'core.agentGitChangeSets': { operation: 'observe' | 'candidate' | 'get_candidate' | 'commit' | 'undo' | 'keep'; changeSetId: string; workspaceRoot: string; payload?: string; expectedVersion?: number; idempotencyKey?: string }
